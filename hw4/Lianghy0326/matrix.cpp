...
PYBIND11_MODULE(_matrix, m)
{
    ...
    m.def("allocate", &CountByte<double>::allocated, "Allocate memory");
    m.def("deallocate", &CountByte<double>::deallocated, "Deallocate memory");
    m.def("bytes", &CountByte<double>::bytes, "Get bytes");
